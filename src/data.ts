...
import InvoiceDepartmentIcon from './InvoiceDepartmentIcon'
...
export const departments: Department[] = [
  ...
  { id:'facturacion', name:'Facturación AI', agent:'INVOICER', role:'Gerente de Facturación AI', description:'CFDI, cobranza, notas de crédito y cuentas por cobrar.', icon:InvoiceDepartmentIcon as unknown as typeof Activity, tone:'green', capabilities:['Emitir y administrar facturas','Gestionar cartera por cobrar','Detectar facturas vencidas','Registrar pagos y cobranza','Facturación recurrente','Notas de crédito y complementos','Reportes de ingresos','Validaciones fiscales'], automations:['Recordatorios de pago automáticos','Detección de facturas vencidas','Facturación recurrente programada','Envío de facturas por correo','Generación de complementos de pago','Alertas de errores fiscales','Reportes de ingresos programados','Estados de cuenta automáticos'] },
  { id:'nominas', name:'Nóminas AI', agent:'PAYROLL', role:'Gerente de Nóminas AI', description:'Cálculo, incidencias, periodos, recibos y compensación coordinados con Recursos Humanos.', icon:PayrollDepartmentIcon as unknown as typeof Activity, tone:'fuchsia', capabilities:['Calcular pre-nómina','Procesar incidencias','Generar recibos y reportes','Prestaciones y finiquitos','Aguinaldo y PTU','Calendario de nómina'], automations:['Pre-cálculo por periodo','Validación de incidencias','Generación documental','Alertas de cierre','Preparación de dispersión','Integración contable'] },
